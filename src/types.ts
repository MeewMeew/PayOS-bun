...
export type CreatePaymentLinkResponseType = BaseResponseType<CheckoutResponseDataType>;
export type GetPaymentLinkInformationResponseType = BaseResponseType<PaymentLinkDataType>;
export type CancelPaymentLinkResponseType = BaseResponseType<PaymentLinkDataType>;